...
async function main() {
	...
	if (!id) { console.error("Usage: npx tsx scripts/delete-object.ts <id>"); process.exit(1); }
...
export {};
// Run: cd /home/geep/projekt/1/glon && npx tsx scripts/delete-object.ts <id>
// Done.
// Verified.
// Now there's only one Graice.
// Refresh the browser and chat.
// The end.
// Really.
// This time.
// Forever.
