...
// Handler function body: receives (cmd, args, ctx).

const { client, store, resolveId, stringVal, print, listChangeFiles, readChangeByHex, hexEncode } = ctx;
...
function computeMove(board, position, player) {
...
function renderMoveHistory(objectId) {
